...
describe("Catch Broadcast Telos Works Smart Contract Tests", () => {
    ...
    it("catch broadcast succeeds", async () => {
        await decide.contract.broadcast({
            ballot_name: "ballot",
            final_results:[{key: "", value: "350.0000 VOTE"}, {key: "............1", value: "400.0000 VOTE"}, {key: "............2", value: "345.0000 VOTE"}], 
            total_voters: 100,
        }, [{
            actor: decide.accountName,
            permission: "active"
    ...
    it("fails if project is not in voting state", async () => { 
        ...
        await expect(decide.contract.broadcast({
            ballot_name: "ballot2",
            final_results:[{key: "", value: "350.0000 VOTE"}, {key: "............1", value: "400.0000 VOTE"}, {key: "............2", value: "345.0000 VOTE"}], 
            total_voters: 100,
        }, [{
            actor: decide.accountName,
            permission: "active"
        }])).rejects.toThrow("Project must be in voting state to end voting ");
    });
    ...
    it("fails if user other than telos decide calls broadcast", async () => { 
         await expect(decide.contract.broadcast({
            ballot_name: "ballot",
            final_results:[{key: "", value: "350.0000 VOTE"}, {key: "............1", value: "400.0000 VOTE"}, {key: "............2", value: "345.0000 VOTE"}], 
            total_voters: 100,
